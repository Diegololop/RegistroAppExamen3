...
import { pencilOutline, trashOutline, add, arrowUp } from 'ionicons/icons';
...
@Component({
  ...
  standalone: true,
  imports: [
    IonList, IonHeader, IonToolbar, IonTitle, IonCard,
    ...
    IonFab, IonFabButton, IonFabList, IonChip,
...
export class ForumComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    addIcons({ pencilOutline, trashOutline, add, arrowUp });
  }
  ...
  editarPublicacion(post: Post) {
    this.post = { ...post };
    this.selectedPostText = `Editando publicación #${post.id}`;
    this.scrollToTop();
  }

  async eliminarPublicacion(post: Post) {
